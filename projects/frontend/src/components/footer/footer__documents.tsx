...
export function FooterDocuments() {
    ...
    useEffect(() => {
        ...
        panelRef.current.style.width = `${bodyRef.current.getBoundingClientRect().width}px`;
    }, [panelRef, bodyRef, dialog1Open, dialog2Open]);

    return (
        <Fragment>
            <ul className={cnFooter('documents')}>
                <li>
                    <button onClick={() => setDialog1Open(true)}>Юридические документы</button>
                </li>
                <li>
                    <button onClick={() => setDialog2Open(true)}>Политика в отношении обработки персональных данных</button>
                </li>
            </ul>
            ...
            >
                ...
                >
                    ...
                    <div className={cnProductCard('dialog-body').mix(cnFooter('obr'))} ref={bodyRef}>
                        <div className={cnFooter('obr__scroll')}>
                            <p>
                                Политика в отношении обработки персональных данных
                            </p>
                            <p>1. Общие положения<br/>
                                Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных» (далее - Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Общество с ограниченной ответственностью «Первый шоколатье» - «Завод геронтодиетологического, детского и органического питания имени В.П. Пастухова» (далее – Оператор).<br/>
                                1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.<br/>
                                1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://pastukhoff.tilda.ws/Home_page.<br/>
                                ...
                                2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://pastukhoff.tilda.ws/Home_page.<br/>
                                ...
                                2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://pastukhoff.tilda.ws/Home_page.<br/>
                                ...
                                2.10. Пользователь – любой посетитель веб-сайта https://pastukhoff.tilda.ws/Home_page.<br/>
                                ...
                                5.4. Фотографии.<br/>
                                5.5. Отзыв/жалоба/предложение/благодарность/другое.<br/>
                                ...
                                – повышение качества продуктов компании; иные цели, указанные в Пользовательском соглашении..<br/>
                                ...
                                8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте https://pastukhoff.tilda.ws/Home_page или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.<br/>
                                ...
                                10.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора k.rybalko@produktpro.ru с пометкой «Актуализация персональных данных».<br/>
                                ...
                                Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора k.rybalko@produktpro.ru с пометкой «Отзыв согласия на обработку персональных данных».<br/>
                                ...
                                14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты k.rybalko@produktpro.ru.<br/>
                                ...
                                14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://pastukhoff.tilda.ws/Home_page.</p>
                        </div>
                    </div>
                </DialogPanel>
            </Dialog>
            ...
            >
                <DialogPanel className={cnProductCard('dialog-panel')} ref={panelRef}>
                    ...
                    <div className={cnProductCard('dialog-body').mix(cnFooter('inn'))} ref={bodyRef}>
                        <p>ИНН 505142779</p>
                        <p>КПП 505001001</p>
                        <p>ОГРН 1195050008867</p>
                        <p>ОКПО 40422314</p>
                        <p>ОКАТО 46442000000</p>
                        <p>ОКФС 16</p>
                        <p>ОКОПФ 12300</p>
                        ...
                        <p>ПОЛНОЕ НАИМЕНОВАНИЕ ОРГАНИЗАЦИИ:
                            ...
                            «Первый шоколатье» - «Завод геронтодиетологического,
                            детского и органического питания имени В.П. Пастухова
						</span>
                        </p>
                    </div>
                </DialogPanel>
