import { assign } from '@/utils/assign/assign.ts';
...
const state = (
	...
	copiedState[prefix] = assign({}, copiedState[prefix] || {}, ...(states as BemStates));
	copiedContext.states = copiedState as BemStates;
